...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6">
      <p className="text-8xl font-black text-zinc-900 mb-0 leading-none select-none">404</p>
      <h1 className="text-2xl font-black uppercase tracking-tight mt-4 mb-2">Page Not Found</h1>
